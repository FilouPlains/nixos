...
# your system.
{
  ...
  */
  getSubPackage = (
    source: list:
      ...
      then builtins.getAttr (builtins.elemAt list 0) source
      else getSubPackage (builtins.getAttr (builtins.elemAt list 0) source) (builtins.tail list)
  );
  ...
  */
  selectedPackage = packageList:
    (lib.subtractLists config.disabledPackage packageList)
